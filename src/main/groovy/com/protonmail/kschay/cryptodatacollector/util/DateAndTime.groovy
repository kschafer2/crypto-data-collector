package com.protonmail.kschay.cryptodatacollector.util
...
class DateAndTime {
    ...
    static Timestamp yesterdayCloseDate() {
        Timestamp.valueOf(new Date(localCloseDate().time - 86400000).toString() + " 00:00:00")
    }
}
